    ...
    .then(function (jsonObject) {
        ...
        for (let i = 0; i < towns.length; i++) {
            if ((towns[i].name == "Fish Haven") || (towns[i].name == "Preston") || (towns[i].name == "Soda Springs")) {
                ...
                if (towns[i].name == "Preston") {townInfo.style.order = "1";} 
                else if (towns[i].name == "Soda Springs") {townInfo.style.order = "2";} 
                else if (towns[i].name == "Fish Haven") {townInfo.style.order = "3";}
