const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5585010&APPID=f69138eabaf7b974bb7452d338551399&units=imperial";
fetch(apiURL)
...
const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5585010&APPID=f69138eabaf7b974bb7452d338551399&units=imperial";
fetch(forecastURL)
  .then((response) => response.json())
  .then((forecastObject) => {
